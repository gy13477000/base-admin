...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // 不需要走springsecurity过滤链
    @Override
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/webjars/**", "/common/**", "/favicon.ico", "/error/*", "/*.html", "/**/*.css", "/**/*.js", "/getVerifyCodeImage", "/loginPage");
    }
    ...
    public DynamicallyUrlInterceptor dynamicallyUrlInterceptor() {
        ...
        // 配置仅需要登录就可以访问的url
        myFilterInvocationSecurityMetadataSource.setOnlyLoginMap("/index", "/websocket/**");
        //初始化拦截器并添加数据源
